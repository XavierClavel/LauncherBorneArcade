...
//     [SerializeField] GameObject arrowToMenu;
...
//     int nbLines;
//     int currentLine = 1;
//     [SerializeField] GameObject nbLinesDisplay_GO;
...
//         infoController.SetupControlsInfo(currentGame);
...
//             if (currentLine == 1)
//             {
//                 arrowToMenu.SetActive(true);
//                 nbLinesDisplay_GO.SetActive(false);
//             }
...
//             if (currentLine == 1)
//             {
//                 arrowToMenu.SetActive(false);
//                 nbLinesDisplay_GO.SetActive(true);
//             }
//             currentLine++;
//             nbLinesDisplay.text = currentLine + "/" + nbLines;
//             Animate();
